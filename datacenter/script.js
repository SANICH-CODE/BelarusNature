const store = new Vuex.Store({
  state: {
    // initial state
    servers: [
    { name: 'BN Team', status: true, adr: '192.168.0.24' },
    { name: 'vass-group.xyz', status: false, adr: '192.168.0.37' },
    { name: 'disk.bn-team.xyz', status: true, adr: '192.168.0.17' },
    { name: 'Vass.Ex', status: true, adr: '192.168.0.23' }] },
